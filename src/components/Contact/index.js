  ...
  <div className="contact__main" ref={refContact}>
    ...
    <div className="contact__details">
      ...
      <div className="contact__details__display">
        <a className="contact__details__a" href="mailto:ckieken@protonmail.com" target="_blank" rel="noreferrer">
      ...
      <div className="contact__details__display">
        <a className="contact__details__a" href="https://www.linkedin.com/in/clement-kieken-1504b168/" target="_blank" rel="noreferrer">
          <img className="contact__details__linkedin" src={linkedin} alt="logo linkedin" />
        </a>
      </div>

      <div className="contact__details__display">
        <a className="contact__details__a" href="https://github.com/Clementkieken" target="_blank" rel="noreferrer">
